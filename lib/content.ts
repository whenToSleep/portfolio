...
export const ARTIST: Artist = {
  ...
  year: 2026,
  email: "starostinaanna2026@gmail.com",
  commissions: "starostinaanna2026@gmail.com",
  press: "starostinaanna2026@gmail.com",
};
...
export const STR: Record<Lang, UIStrings> = {
  en: {
    ...
    home_statement: "Book illustrator — I create playbills, posters and book covers. I draw in graphic techniques: ink/pen and digital.",
    ...
    home_reach_label: "— Social —",
    home_follow_label: "— Follow —",
    home_social: [
      ["Telegram", "@c1tsyne", "https://t.me/c1tsyne"],
      ["Instagram", "", "#"],
      ["TikTok", "", "#"],
    ],
    ...
    roles: [
      ["Contact", "Anna Starostina", "starostinaanna2026@gmail.com"],
      ["Commissions & collaboration", "All enquiries", "starostinaanna2026@gmail.com"],
    ],
    dist_label: "— Telegram —",
    dist: [["Telegram", "@c1tsyne", "https://t.me/c1tsyne"]],
    type_label: "",
    type_body: "",
  ...
  uk: {
    ...
    home_statement: "Книжковий ілюстратор, створюю: афіші, плакати, обкладинки книг. Малюю в техніці графіка, туш/перо, digital.",
    ...
    roles: [
      ["Зв'язок", "Анна Старостіна", "starostinaanna2026@gmail.com"],
      ["Замовлення та співпраця", "Усі запити", "starostinaanna2026@gmail.com"],
    ],
    dist_label: "— Телеграм —",
    dist: [["Telegram", "@c1tsyne", "https://t.me/c1tsyne"]],
    type_label: "",
